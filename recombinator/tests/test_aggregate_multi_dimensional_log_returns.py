...
expected_aggregated_array = np.array([[[4, 6], [12, 14]], [[400, 600], [1200, 1400]]])


def test_aggregate_multi_dimensional_log_returns():
    aggregated_example = aggregate_multi_dimensional_log_returns(
        log_returns=example_array, number_of_observations_to_aggregate=2
    )
